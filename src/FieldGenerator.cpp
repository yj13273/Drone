...
FieldGenerator::FieldGenerator(
    ...
    sensors(sensors),
    nfzs(nfzs),
    config{Config::SIMULATION_Z, true, true, true, true, true, false, 1.0, 1.0, 1.0, 1.0}
{
    final_cost.resize(
        terrain.width *
        terrain.height,
...
bool FieldGenerator::pointInsideTriangle(
    int px,
    int py,
...
void FieldGenerator::calculateChunk(
    int start_y,
    int end_y,
...
void FieldGenerator::exportCostMatrix(
...
FieldGenerator::getCostMatrix() const
{
    return final_cost;
}
