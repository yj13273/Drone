...
FieldGenerator::FieldGenerator(const TerrainData& terrain, const std::vector<SensorSite>& sensors, const std::vector<NFZTriangle>& nfzs)
    : terrain(terrain),
      sensors(sensors),
      nfzs(nfzs),
      config{Config::SIMULATION_Z,
             true,
             true,
             true,
             true,
